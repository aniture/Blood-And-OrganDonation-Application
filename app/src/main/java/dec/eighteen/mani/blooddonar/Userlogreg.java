...
public class Userlogreg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userlogreg);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(un.getText().toString().contentEquals("") && pass.getText().toString().contentEquals("") && mail.getText().toString().contentEquals("") && phno.getText().toString().contentEquals("") &&
                    ...
                    Toast.makeText(Userlogreg.this,
                ...
                else if (!(mail.getText().toString()).matches(emailPattern) )
                {
                    ...
                    dbh = new DatabaseHelper(Userlogreg.this);
                    dbh.open();
                    ...
                    dbh.close();
                    Intent i=new Intent(Userlogreg.this, Userlogin.class);
                    startActivity(i);
                    finish();
                }
